...
import { getStaffMember, updateStaff, type StaffMember } from "@/lib/api/staff";
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground">Account Since</p>
                    <p className="font-medium text-foreground">{staff?.createdAt ?? "—"}</p>
                  </div>
                </div>
              </div>
              <p className="text-xs text-muted-foreground">
                Full name, Admin ID, and Access Level are fixed for this account.
              </p>
            </div>
          </div>
        </CardContent>
